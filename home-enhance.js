...
function enhanceLegacyHome(){
  ...
  cards.forEach((card,index)=>{
    ...
    if(img){
      ...
      const code=String(card.dataset.id||'').slice(0,5).toUpperCase();media.insertAdjacentHTML('beforeend',`<span class="code-badge">#${code}</span><span class="photo-badge">📷 3</span>`);
    }
...
const observer=new MutationObserver(enhanceLegacyHome);observer.observe(document.body,{childList:true,subtree:true});setTimeout(enhanceLegacyHome,80);setInterval(enhanceLegacyHome,1200);
